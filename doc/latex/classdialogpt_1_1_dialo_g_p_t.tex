...
\item 
def \mbox{\hyperlink{classdialogpt_1_1_dialo_g_p_t_a9f7e85ba1eb378df1bf57bbeef151e35}{\+\_\+\+\_\+init\+\_\+\+\_\+}} (self, \mbox{\hyperlink{classdialogpt_1_1_dialo_g_p_t_a530bab86aab98e328ddb7f4bc18dce98}{window\+\_\+size}}=10)
...
\begin{DoxyCompactList}\small\item\em Возвращает длину текста, которую стоит сгенерировать боту \end{DoxyCompactList}\item 
...
def \mbox{\hyperlink{classdialogpt_1_1_dialo_g_p_t_a553fdc4a504f537e23191399b46f0209}{process\+\_\+text}} (self, input\+\_\+user)
...
\begin{DoxyCompactList}\small\item\em Забывает предыдущий диалог \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\hyperlink{classdialogpt_1_1_dialo_g_p_t_a9603b216b1ed4304e674f872f2c4a995}{model}} = Auto\+Model\+For\+Causal\+L\+M.\+from\+\_\+pretrained(\char`\"{}Grossmend/rudialogpt3\+\_\+medium\+\_\+based\+\_\+on\+\_\+gpt2\char`\"{})
\begin{DoxyCompactList}\small\item\em Токенайзер модели \mbox{\hyperlink{classdialogpt_1_1_dialo_g_p_t}{Dialo\+G\+PT}}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\Hypertarget{classdialogpt_1_1_dialo_g_p_t_a9f7e85ba1eb378df1bf57bbeef151e35}\label{classdialogpt_1_1_dialo_g_p_t_a9f7e85ba1eb378df1bf57bbeef151e35}} 
...
{\footnotesize\ttfamily def dialogpt.\+Dialo\+G\+P\+T.\+\_\+\+\_\+init\+\_\+\+\_\+ (\begin{DoxyParamCaption}\item[{}]{self,  }\item[{}]{window\+\_\+size = {\ttfamily 10} }\end{DoxyParamCaption})}
...
См. определение в файле dialogpt.\+py строка 20
...
См. определение в файле dialogpt.\+py строка 43
...
\begin{DoxyParams}{Аргументы}
{\em text} & Текст пользователя без команды \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Возвращает}
Длину текста, которую стоит сгенерировать боту, или -\/ если она безгранична 
\end{DoxyReturn}
...
См. определение в файле dialogpt.\+py строка 102

\mbox{\Hypertarget{classdialogpt_1_1_dialo_g_p_t_a553fdc4a504f537e23191399b46f0209}\label{classdialogpt_1_1_dialo_g_p_t_a553fdc4a504f537e23191399b46f0209}} 
...
{\footnotesize\ttfamily def dialogpt.\+Dialo\+G\+P\+T.\+process\+\_\+text (\begin{DoxyParamCaption}\item[{}]{self,  }\item[{}]{input\+\_\+user }\end{DoxyParamCaption})}
...
См. определение в файле dialogpt.\+py строка 75
...
См. определение в файле dialogpt.\+py строка 133
...
{\footnotesize\ttfamily dialogpt.\+Dialo\+G\+P\+T.\+model = Auto\+Model\+For\+Causal\+L\+M.\+from\+\_\+pretrained(\char`\"{}Grossmend/rudialogpt3\+\_\+medium\+\_\+based\+\_\+on\+\_\+gpt2\char`\"{})\hspace{0.3cm}{\ttfamily [static]}}
...
См. определение в файле dialogpt.\+py строка 16
...
См. определение в файле dialogpt.\+py строка 23



Объявления и описания членов класса находятся в файле\+:\begin{DoxyCompactItemize}
\item 
prod/utils/telegram/\mbox{\hyperlink{dialogpt_8py}{dialogpt.\+py}}\end{DoxyCompactItemize}
